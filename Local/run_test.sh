...
# docker-compose -f $current_dir/docker-compose.yml --env-file=$current_dir/.env -p $COMPOSE_ID rm -f

# Starting new stack environment
docker-compose -f $current_dir/docker-compose.yml --env-file=$current_dir/.env -p $COMPOSE_ID up --build